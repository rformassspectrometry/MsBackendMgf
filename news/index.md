...
- Add an example to the vignette describing how to export only selected
  spectra variables to the MGF file.
...
- Add examples how to use the `MsBackendMgf` backend to export data to
  mgf files (issue
  [\#4](https://github.com/rformassspectrometry/MsBackendMgf/issues/4).

### Changes in 0.2.0

- Add `export` method to support exporting of data from a `Spectra`
  object in mgf file format.
